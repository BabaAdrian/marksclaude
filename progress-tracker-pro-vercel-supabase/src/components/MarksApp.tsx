...
import {
  actorLabel, classesFor, gradeFor, totalFor, uid,
...
export default function MarksApp() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 text-slate-800 flex flex-col">
      <TopBar session={session} onLogout={() => setSession(null)} saveState={saveState} />
...
function TopBar({ session, onLogout, saveState }: { session: Session; onLogout: () => void; saveState: string }) {
  return (
